...
export const createProductController = async (req, res) => {
  try {
    const { name, slug, description, price, category, quantity, isShip } =
      req.fields;
...
export const getSingleController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      message: "Error when get your item",
      error,
    });
  }
};

//get product photo picture
...
export const updateProductController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      error,
      message: "Error when update product",
    });
  }
};
...
//get product through category
export const productInCategoryController = async (req, res) => {
  try {
